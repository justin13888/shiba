                ...
                <form onSubmit={handleFormSubmit}>
                  <div class="grid gap-2">
                    ...
                    <Select
                      ...
                      options={[DarkMode.System, DarkMode.Light, DarkMode.Dark]}
                      placeholder="Select dark mode..."
                      itemComponent={(props) => (
                        <SelectItem item={props.item}>
                          {darkModeToString(props.item.rawValue)}
                        </SelectItem>
                      )}
                    >
                      <SelectTrigger aria-label="Dark Mode">
                        <SelectValue<DarkMode>>
                          {(state) => darkModeToString(state.selectedOption())}
                        </SelectValue>
                      </SelectTrigger>
                      <SelectContent />
                    </Select>
                  ...
                  <div class="grid gap-2">
                    ...
                    <Select
                      ...
                      options={[Theme.Default, Theme.Custom]}
                      placeholder="Select theme..."
                      itemComponent={(props) => (
                        <SelectItem item={props.item}>
                          {themeToString(props.item.rawValue)}
                        </SelectItem>
                      )}
                    >
                      <SelectTrigger aria-label="Theme">
                        <SelectValue<Theme>>
                          {(state) => themeToString(state.selectedOption())}
                        </SelectValue>
                      </SelectTrigger>
                      <SelectContent />
                    </Select>
                  ...
                  <div class="grid gap-2">
                    ...
                    <Select
                      ...
                      options={Object.values(Locale) as Locale[]}
                      placeholder="Select tjeme..."
                      itemComponent={(props) => (
                        <SelectItem item={props.item}>
                          {localeToString(props.item.rawValue)}
                        </SelectItem>
                      )}
                    >
                      <SelectTrigger aria-label="Theme">
                        <SelectValue<Locale>>
                          {(state) => localeToString(state.selectedOption())}
                        </SelectValue>
                      </SelectTrigger>
                      <SelectContent />
                    </Select>
