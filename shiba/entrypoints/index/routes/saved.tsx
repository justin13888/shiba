                    ...
                    <For each={tabGroups()}>
                      {(tabGroup) => (
                        <TabGroupList
                          {...{
                            tabGroup,
                            tabGroupsRefetch: tabGroupsQuery.refetch,
                          }}
                        />
                      )}
                    </For>
  ...
  return (
    <Switch fallback={<div>Loading...</div>}>
      <Match when={tabsQuery.isSuccess}>
        <Show when={tabsQuery.data} fallback={<p>There are no tabs...</p>}>
          {(tabs) => (
            <div class="m-4">
              <div class="flex flex-row items-center space-x-4 pb-4">
                ...
                <p class="pl-4">
                  Last modified {diffDate(tabGroup.timeModified)}
                </p>
              </div>
