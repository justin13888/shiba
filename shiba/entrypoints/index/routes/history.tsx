...
const History: Component = () => {
    const [snapshots, {refetch: snapshotRefetch}] = createResource(getSnapshots); // TODO: Replace with solid infintie query and virtual
        ...
        <div class="flex min-h-screen w-full flex-col items-center justify-center bg-background px-4 py-12 md:px-6">
            <div class="w-full max-w-screen-lg space-y-6">
                ...
                <div class="space-y-4">
                    ...
                    <h2 class="text-lg font-medium text-gray-600">Snapshots</h2>
                            ...
                            >
                                <Match when={snapshots().length > 0}>
                                    <Table>
                                        ...
                                        <TableCaption>
                                            Snapshots as of{" "}
                                            {dateFormatter.format(lastUpdated())}.
                                        </TableCaption>
                                    </Table>
