      ...
      <div class="w-full max-w-screen-lg space-y-6">
        ...
        >
          {(snapshot) => {
            ...
            const tabRecord: Record<string, Tab> = snapshot().tabs.reduce(
              (acc, tab) => {
                acc[tab.id] = tab;
                return acc;
              },
            ...
            return (
              <>
                ...
                <div class="flex flex-col">
                  <p>
                    <strong>Identifier:</strong> {snapshot().identifier}
                  </p>
                  <p>
                    <strong>Timestamp:</strong>{" "}
                    {dateFormatter.format(snapshot().timestamp)}
                  </p>
                  <p>
                  ...
                  >
                    <Match when={tabGroups.length > 0}>
                      <div class="flex-col space-y-6">
                        <For each={tabGroups}>
                          {(tabGroup) => {
                            const tabs = tabRecord[tabGroup.id];
                            ...
                            return (
                              <>
                                <div class="flex flex-row items-center space-x-4">
                                  ...
                                  <p>{diffDate(tabGroup.timeCreated)}</p>
                                </div>
