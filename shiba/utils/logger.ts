...
export class Logger {
  ...
  trace(message: string, ...meta: any[]) { this._log(LogLevel.TRACE, message, meta); }
  // biome-ignore lint/suspicious/noExplicitAny: Require
  debug(message: string, ...meta: any[]) { this._log(LogLevel.DEBUG, message, meta); }
  // biome-ignore lint/suspicious/noExplicitAny: Require
  info(message: string, ...meta: any[]) { this._log(LogLevel.INFO, message, meta); }
  // biome-ignore lint/suspicious/noExplicitAny: Require
  warn(message: string, ...meta: any[]) { this._log(LogLevel.WARN, message, meta); }
  // biome-ignore lint/suspicious/noExplicitAny: Require
  error(message: string, ...meta: any[]) { this._log(LogLevel.ERROR, message, meta); }
  // biome-ignore lint/suspicious/noExplicitAny: Require
  fatal(message: string, ...meta: any[]) { this._log(LogLevel.FATAL, message, meta); }
}
