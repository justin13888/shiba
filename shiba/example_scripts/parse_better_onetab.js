...
fs.readFile(filePath, 'utf8', (err, data) => {
  ...
  try {
    ...
    if (Array.isArray(jsonData) && jsonData.every(item => item.tabs && Array.isArray(item.tabs))) {
      ...
      console.error('Invalid JSON data format. Expected an array of objects with a "tabs" property.');
    }
  } catch (error) {
